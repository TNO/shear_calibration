% Reliability analysis FERUM: crude Monte Carlo
%
%SYNOPSYS
% [beta, simulationresults, probdata] = RUN_RELI_cMC(Prob, Options)
%
%

%NOTES:

function [beta, simulationresults, probdata] = run_reli_cMC(Prob, Options)
...
%rv_order: {'C', 'f_cc', 'd', 'b', 'Asl', 'G', 'K_G', 'ksi', 'Q1', 'K_Q1', 'psi01', 'Q2', 'K_Q2', 'psi02'};    
probdata.correlation(3,6) = 0.90; probdata.correlation(6,3) = probdata.correlation(3,6);
...
analysisopt.num_sim              = 5e7   ;   % Number of samples (MC,IS), number of samples per subset step (SS) or number of directions (DS)
