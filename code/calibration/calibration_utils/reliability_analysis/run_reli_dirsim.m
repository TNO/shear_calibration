% Reliability analysis FERUM: directional simulation
%
%SYNOPSYS
% [beta, simulationresults, probdata] = RUN_RELI_dirsim(Prob, Options)
%
%

%NOTES:

function [beta, dirsimulationresults, probdata] = run_reli_dirsim(Prob, Options)
...
beta = dirsimulationresults.beta;
