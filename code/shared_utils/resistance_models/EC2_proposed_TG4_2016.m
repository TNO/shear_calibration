% EC2 based shear resistance formula (proposal TG4_CSCT_2016-08-18)
%
% VR = EC2_proposed_TG4_2016(fc, Asl, b, d, C_c, gamma_C)
%
...
function VR = EC2_proposed_TG4_2016(fc, Asl, b, d, C_c, gamma_C)
